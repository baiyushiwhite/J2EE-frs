...
public class CommonUserJoinProjectAction extends BaseAction{
	/**
	 * 
	 */
	...
	public String execute() throws Exception{
		...
		//返回当前userId所参与的所有项目列表
		
		List<?> allList = projectService.getAllMyJoinProjectByBeginTime(currentUser.getUserId());
